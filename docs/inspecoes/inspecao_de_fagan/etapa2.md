...
|---         |--------                                                           |------                                                             |
| ET2_LST1   | Lista de verificação para a primeira etapa elaborada pelo grupo 4 | [link](../../verificacao/checklist_2.md)                          |
| ET2_LST2   | Lista de verificação - Etapa 1                                    | [link](https://aprender3.unb.br/mod/resource/view.php?id=1399913) |
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/I42hWt57DQk?si=wRnQiZ5Y6WCK2ic6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/gb7TE1da3jo?si=aPl7xKAqA8e_541c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
|------ |-------------------                                                    |-------------------------------                                               |
| DEF01 | AUSÊNCIA DE TABELA DE FUNÇÃO DOS AUTORES                              | [Análise de Documentação](../../elicitacao/tecnicas/analise_documentacao.md) |
| DEF02 | TABELAS DE VALIDAÇÃO FORA DE PADRONIZAÇÃO                             | [Análise de Documentação](../../elicitacao/tecnicas/analise_documentacao.md) |
| DEF03 | PRIORIZAÇÃO DESATUALIZADA EM RELAÇÃO A ARTEFATOS RASTREÁVEIS          | [Three Level Scale](../../elicitacao/priorizacao/three_level_scale.md)       |
...
| DEFX  | Defeito                                                                     | Artefato                                                                      |
|------ |-------------------                                                          |-------------------------------                                                |
| DEF04 | TABELAS DA SEÇÃO DE VALIDAÇÃO FORA DE PADRONIZAÇÃO                          | [Análise de Documentação](../../elicitacao/tecnicas/analise_documentacao.md)  |
| DEF05 | TABELAS DA SEÇÃO DE VALIDAÇÃO FORA DE PADRONIZAÇÃO                          | [Introspecção](../../elicitacao/tecnicas/introspecção.md)                     |
| DEF06 | AUSÊNCIA DE SEÇÃO PARA HISTÓRICO DE VERSÃO                                  | [Requisitos Elicitados](../../elicitacao/requisitos_elicitados.md)            |
| DEF07 | TABELA DE CONTEÚDOS NÃO LISTA OS CONTEÚDOS DO DOCUMENTO                     | [Requisitos Elicitados](../../elicitacao/requisitos_elicitados.md)            |
| DEF08 | DOCUMENTO NÃO EXISTENTE "Requisitos Desejáveis" LISTADO NA SEÇÃO ELICITAÇÃO | [Configuração da Página](../../../mkdocs.yml)                                 |
| DEF09 | AUSÊNCIA DE HYPERLINKS PARA FONTE DOS REQUISITOS PRIORIZADOS                | [MoSCoW](../../elicitacao/priorizacao/moscow.md)                              |
| DEF10 | TABELA DE CONTEÚDOS NÃO LISTA CORRETAMENTE CONTEÚDOS DO DOCUMENTO           | [MoSCoW](../../elicitacao/priorizacao/moscow.md)                              |
| DEF11 | AUSÊNCIA DE PRIORIZAÇÃO COM O USUÁRIO E/OU VALIDAÇÃO DA PRIORIZAÇÃO         | [MoSCoW](../../elicitacao/priorizacao/moscow.md)                              |
| DEF12 | BIBLIOGRAFIA NOMEADA COMO "Referências"                                     | [MoSCoW](../../elicitacao/priorizacao/moscow.md)                              |
| DEF13 | PRIORIZAÇÃO DESATUALIZADA EM RELAÇÃO A ARTEFATOS RASTREÁVEIS                | [MoSCoW](../../elicitacao/priorizacao/moscow.md)                              |
| DEF14 | LEGENDA NA SEÇÃO "Metodologia" FORA DE PADRÃO                               | [MoSCoW](../../elicitacao/priorizacao/moscow.md)                              |
