...
As personas foram divididas em três categorias para refletir a diversidade de perfis de usuários que interagem com o aplicativo:

- **Personas Primárias:** Usuários diretos do sistema, que interagem com o aplicativo de forma constante.
- **Personas Secundárias:** Usuários que, embora não sejam os principais, influenciam o uso do sistema ou se beneficiam dele indiretamente.
- **Antipersonas:** Usuários que têm dificuldades ou não se beneficiam da utilização do sistema.
